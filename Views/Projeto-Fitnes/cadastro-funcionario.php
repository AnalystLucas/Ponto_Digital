...
<head>
  ...
  <title>Ponto Digital - Cadastro de funcionário</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Cadastro de Funcionários</h6>
            </div>
            <div class="card-body">
            <form method="POST" class="user">    
              ...
              <div class="form-group">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 align-items-center">
                  <button class="btn btn-primary btn-user btn-block" id="btn_cadastrar">Cadastrar Funcionario</button>
                </div>
              </div>
            </form>
